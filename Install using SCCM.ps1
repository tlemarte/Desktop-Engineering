...
Begin {
    $Application = (Get-CimInstance -ClassName CCM_Application -Namespace "root\ccm\clientSDK" -ComputerName $Computername `
...
Trigger-AppInstallation $env:computername "Midmark 3.0 - Midmark 3.0" Install